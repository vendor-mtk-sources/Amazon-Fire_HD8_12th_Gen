			      ...
			      const char *name)
{
	if (strncmp(name, "I2S0", 4) == 0)
		return MT8169_DAI_I2S_0;
	else if (strncmp(name, "I2S1", 4) == 0)
		return MT8169_DAI_I2S_1;
	else if (strncmp(name, "I2S2", 4) == 0)
		return MT8169_DAI_I2S_2;
	else if (strncmp(name, "I2S3", 4) == 0)
		return MT8169_DAI_I2S_3;
	else
		return -EINVAL;
}
...
static struct mtk_clk_ao_attr *get_i2s_ao_by_name(struct mtk_base_afe *afe,
							 const char *name)
{
	struct mt8169_afe_private *afe_priv = afe->platform_priv;
	int dai_id = get_i2s_id_by_name(afe, name);
...
/* low jitter control */
static const char * const mt8169_i2s_hd_str[] = {
	"Normal", "Low_Jitter"
};

static const struct soc_enum mt8169_i2s_enum[] = {
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt8169_i2s_hd_str),
			    mt8169_i2s_hd_str),
};

/* clock source control */
static const char * const mt8169_i2s_src_str[] = {
	"Master", "Slave"
};

static const struct soc_enum mt8169_i2s_src_enum[] = {
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt8169_i2s_src_str),
			    mt8169_i2s_src_str),
};

static int mt8169_i2s_hd_get(struct snd_kcontrol *kcontrol,
...
static int mt8169_i2s_hd_set(struct snd_kcontrol *kcontrol,
			     struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt8169_i2s_src_get(struct snd_kcontrol *kcontrol,
			     struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt8169_i2s_src_set(struct snd_kcontrol *kcontrol,
			     struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static const struct snd_kcontrol_new mtk_dai_i2s_controls[] = {
	SOC_ENUM_EXT(MTK_AFE_I2S0_KCONTROL_NAME, mt8169_i2s_enum[0],
		     mt8169_i2s_hd_get, mt8169_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2S1_KCONTROL_NAME, mt8169_i2s_enum[0],
		     mt8169_i2s_hd_get, mt8169_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2S2_KCONTROL_NAME, mt8169_i2s_enum[0],
		     mt8169_i2s_hd_get, mt8169_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2S3_KCONTROL_NAME, mt8169_i2s_enum[0],
		     mt8169_i2s_hd_get, mt8169_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2S0_SRC_KCONTROL_NAME, mt8169_i2s_src_enum[0],
		     mt8169_i2s_src_get, mt8169_i2s_src_set),
};
...
static const struct snd_kcontrol_new mtk_i2s3_ch1_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("SRC_1_OUT_CH1", AFE_CONN0_1,
				    I_SRC_1_OUT_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("SRC_2_OUT_CH1", AFE_CONN0_1,
				    I_SRC_2_OUT_CH1, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_i2s3_ch2_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("SRC_1_OUT_CH2", AFE_CONN1_1,
				    I_SRC_1_OUT_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("SRC_2_OUT_CH2", AFE_CONN1_1,
				    I_SRC_2_OUT_CH2, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_i2s1_ch1_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("SRC_1_OUT_CH1", AFE_CONN28_1,
				    I_SRC_1_OUT_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("SRC_2_OUT_CH1", AFE_CONN28_1,
				    I_SRC_2_OUT_CH1, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_i2s1_ch2_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("SRC_1_OUT_CH2", AFE_CONN29_1,
				    I_SRC_1_OUT_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("SRC_2_OUT_CH2", AFE_CONN29_1,
				    I_SRC_2_OUT_CH2, 1, 0),
};
			    ...
			    int event)
{
	...
	reg = i2s_priv->i2s_reg;
	shift = i2s_priv->i2s_en_sft;
	mask_shift = i2s_priv->i2s_en_mask_sft;

	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		regmap_update_bits(afe->regmap, reg, mask_shift, 0x1 << shift);
		mt8169_afe_gpio_request(afe->dev, true, i2s_priv->id, 0);
		break;
	case SND_SOC_DAPM_POST_PMD:
		mt8169_afe_gpio_request(afe->dev, false, i2s_priv->id, 0);
			       ...
			       int event)
{
	...
	reg = i2s_priv->i2s_reg;
	shift = i2s_priv->i2s_hd_sft;
	mask_shift = i2s_priv->i2s_hd_mask_sft;
			  ...
			  int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		if (strcmp(w->name, APLL1_W_NAME) == 0)
			mt8169_apll1_enable(afe);
		else
			mt8169_apll2_enable(afe);
		break;
	case SND_SOC_DAPM_POST_PMD:
		if (strcmp(w->name, APLL1_W_NAME) == 0)
			     ...
			     int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		mt8169_mck_enable(afe, i2s_priv->mclk_id, i2s_priv->mclk_rate);
		break;
	case SND_SOC_DAPM_POST_PMD:
		i2s_priv->mclk_rate = 0;
		mt8169_mck_disable(afe, i2s_priv->mclk_id);
		break;
	default:
		break;
	}
...
static int mtk_afe_i2s_ao_connect(struct snd_soc_dapm_widget *source,
				     struct snd_soc_dapm_widget *sink)
{
	...
	attr = get_i2s_ao_by_name(afe, w->name);
	if (!attr) {
				     ...
				     struct snd_soc_dapm_widget *sink)
{
	...
	if (!mtk_afe_i2s_ao_connect(source, sink))
		return 0;
				    ...
				    struct snd_soc_dapm_widget *sink)
{
	...
	i2s_need_apll = mt8169_get_apll_by_rate(afe, i2s_priv->rate);
...
static const struct snd_soc_dapm_route mtk_dai_i2s_routes[] = {
	...
	/* i2s0 */
	{"I2S0", NULL, "I2S0_EN", mtk_afe_i2s_ao_connect},
	...
	{"I2S1_CH1", "DL3_CH1", "DSP_DL3_VIRT"},
	{"I2S1_CH2", "DL3_CH2", "DSP_DL3_VIRT"},
#endif
	...
	{"I2S1", NULL, "I2S1_EN", mtk_afe_i2s_ao_connect},
	...
	{"I2S2", NULL, "I2S2_EN", mtk_afe_i2s_ao_connect},
	...
	{"I2S3", NULL, "I2S3_EN", mtk_afe_i2s_ao_connect},
					 ...
					 struct snd_soc_dai *dai)
{
	...
	unsigned int rate_reg = mt8169_rate_transform(afe->dev,
						      rate, dai->id);
			      ...
			      int i2s_id)
{
	...
	struct mtk_clk_ao_attr *dai_attr = &afe_priv->clk_ao_data[i2s_id];
...
static const struct mtk_afe_i2s_priv mt8169_i2s_priv[DAI_I2S_NUM] = {
	[DAI_I2S0] = {
		.id = MT8169_DAI_I2S_0,
		...
		.share_i2s_id = -1,
		.i2s_reg = AFE_I2S_CON,
		.i2s_en_sft = I2S_EN_SFT,
		.i2s_en_mask_sft = I2S_EN_MASK_SFT,
		.i2s_hd_sft = I2S1_HD_EN_SFT,
		.i2s_hd_mask_sft = I2S1_HD_EN_MASK_SFT,
	},
	[DAI_I2S1] = {
		.id = MT8169_DAI_I2S_1,
		...
		.share_i2s_id = -1,
		.i2s_reg = AFE_I2S_CON1,
		.i2s_en_sft = I2S2_EN_SFT,
		.i2s_en_mask_sft = I2S2_EN_MASK_SFT,
		.i2s_hd_sft = I2S2_HD_EN_SFT,
		.i2s_hd_mask_sft = I2S2_HD_EN_MASK_SFT,
	},
	[DAI_I2S2] = {
		.id = MT8169_DAI_I2S_2,
		...
		.share_i2s_id = -1,
		.i2s_reg = AFE_I2S_CON2,
		.i2s_en_sft = I2S3_EN_SFT,
		.i2s_en_mask_sft = I2S3_EN_MASK_SFT,
		.i2s_hd_sft = I2S3_HD_EN_SFT,
		.i2s_hd_mask_sft = I2S3_HD_EN_MASK_SFT,
	},
	[DAI_I2S3] = {
		.id = MT8169_DAI_I2S_3,
		...
		.share_i2s_id = -1,
		.i2s_reg = AFE_I2S_CON3,
		.i2s_en_sft = I2S4_EN_SFT,
		.i2s_en_mask_sft = I2S4_EN_MASK_SFT,
		.i2s_hd_sft = I2S4_HD_EN_SFT,
		.i2s_hd_mask_sft = I2S4_HD_EN_MASK_SFT,
	}
};

int mt8169_dai_i2s_get_share(struct mtk_base_afe *afe)
{
	struct mt8169_afe_private *afe_priv = afe->platform_priv;
	...
	for (i = 0; i < DAI_I2S_NUM; i++) {
		i2s_priv = afe_priv->dai_priv[mt8169_i2s_priv[i].id];
		property_name = mt8169_i2s_priv[i].share_property_name;
...
int mt8169_dai_i2s_set_priv(struct mtk_base_afe *afe)
{
	int i;
	int ret;

	for (i = 0; i < DAI_I2S_NUM; i++) {
		ret = mt8169_dai_set_priv(afe, mt8169_i2s_priv[i].id,
...
int mt8169_dai_i2s_register(struct mtk_base_afe *afe)
{
	...
	ret = mt8169_dai_i2s_set_priv(afe);
	if (ret)
		return ret;

	/* parse share i2s */
	ret = mt8169_dai_i2s_get_share(afe);
	if (ret)
		return ret;
