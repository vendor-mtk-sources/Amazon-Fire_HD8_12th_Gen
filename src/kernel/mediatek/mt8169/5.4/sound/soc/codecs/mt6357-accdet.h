...
#define MT6357_AUXADC_RQST_CH5_ADDR                          \
	MT6357_AUXADC_RQST0
...
extern int mt6357_accdet_init(struct snd_soc_component *component,
			struct snd_soc_card *card);
extern int mt6357_accdet_set_drvdata(struct snd_soc_card *card);
#endif
