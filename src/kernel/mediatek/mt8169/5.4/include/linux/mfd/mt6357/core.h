...
enum mt6357_irq_numbers {
	...
	MT6357_IRQ_abc123_LV = 96,
	MT6357_IRQ_abc123_HT = 97,
...
#define MT6357_IRQ_BM_BITS (MT6357_IRQ_abc123_HT - MT6357_IRQ_BM_BASE + 1)
...
{	\
	...
	[MT6357_IRQ_Vabc123_UNDET] = {.name = "vabc123_undet"},	\
	...
	[MT6357_IRQ_abc123_LV] = {.name = "abc123_lv"},	\
	[MT6357_IRQ_abc123_HT] = {.name = "abc123_ht"},	\
