...
static const struct efuse_chip_data mt6358_efuse_data = {
	.reg_num = 128,
	.base = MT6358_OTP_CON0,
	.ck_pdn = MT6358_TOP_CKPDN_CON0,
	.ck_pdn_hwen = MT6358_TOP_CKHWEN_CON0
};
