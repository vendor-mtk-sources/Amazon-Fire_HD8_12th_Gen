...
{
	pr_info("%s: The original frequency before decode is: %d\n", __func__, vco_freq);

	if ((vco_freq > 700) && (vco_freq <= 800))
		return 800;

	if ((vco_freq > 1100) && (vco_freq <= 1200))
		return 1200;

	if ((vco_freq > 1200) && (vco_freq <= 1333))
		return 1333;

	if ((vco_freq > 1500) && (vco_freq <= 1600))
		return 1600;

	if ((vco_freq > 1600) && (vco_freq <= 1866))
		return 1866;

	if ((vco_freq > 1866) && (vco_freq <= 2133))
		return 2133;

	if ((vco_freq > 2133) && (vco_freq <= 2400))
		return 2400;

	if ((vco_freq > 2400) && (vco_freq <= 2666))
		return 2666;

	if ((vco_freq > 2666) && (vco_freq <= 3200))
		return 3200;

	if ((vco_freq > 3200) && (vco_freq <= 3600))
		return 3600;

	if ((vco_freq > 3600) && (vco_freq <= 3733))
		return 3733;

	if ((vco_freq > 3733) && (vco_freq <= 4266))
		return 4266;
