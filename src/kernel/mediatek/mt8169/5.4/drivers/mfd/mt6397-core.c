...
#define MT6357_RTC_BASE		MT6358_RTC_BASE
#define MT6357_RTC_SIZE		MT6358_RTC_SIZE
...
static const struct resource mt6359p_gauge_resources[] = {
	...
	DEFINE_RES_IRQ_NAMED(MT6359P_IRQ_abc123_BAT_OU, "BAT_OUT"),
...
static const struct mfd_cell mt6357_devs[] = {
	{
		...
		.name = "mt6357-pmic-temp",
		.of_compatible = "mediatek,mt6357-pmic-temp",
	}, {
		...
		.of_compatible = "mediatek,mt6357-clock-buffer",
	},
};
