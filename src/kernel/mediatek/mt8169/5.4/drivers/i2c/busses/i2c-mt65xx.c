...
static const struct mtk_i2c_compatible mt8169_compat = {
	.regs = mt_i2c_regs_v2,
	.pmic_i2c = 0,
	.dcm = 0,
	.auto_restart = 1,
...
static const struct of_device_id mtk_i2c_of_match[] = {
	...
	{ .compatible = "mediatek,mt8169-i2c", .data = &mt8169_compat },
			    ...
			    struct i2c_msg msgs[], int num)
{
	...
	pm_qos_update_request(&i2c->i2c_qos_request, 150);
...
err_exit:
	pm_qos_update_request(&i2c->i2c_qos_request, PM_QOS_DEFAULT_VALUE);
...
static int mtk_i2c_probe(struct platform_device *pdev)
{
	...
	pm_qos_add_request(&i2c->i2c_qos_request, PM_QOS_CPU_DMA_LATENCY,
