...
#define PWRAP_STATE_INIT_DONE0_V2	(1 << 22) /* MT8169 */
...
#define PWRAP_CAP_ARB_V2	BIT(8) /* MT8169 */
...
static struct pmic_wrapper_type pwrap_mt8169 = {
	.regs = mt8169_regs,
	.type = PWRAP_MT8169,
	.arb_en_all = 0xfb27f,
	.int_en_all = 0xfffffffc,
...
static const struct of_device_id of_pwrap_match_tbl[] = {
	{
		...
		.compatible = "mediatek,mt8169-pwrap",
		.data = &pwrap_mt8169,
	}, {
...
static int pwrap_probe(struct platform_device *pdev)
{
	...
	else if (!HAS_CAP(wrp->master->caps, PWRAP_CAP_ARB_V2)) /* MT8169 */
		rdata = pwrap_readl(wrp, PWRAP_WACS2_RDATA) &
