...
u32 dvfsrc_get_required_opp_peak_bw(struct device_node *np, int index)
{
	...
	if (of_property_read_u32_index(required_np, "opp-peak-KBps",
		dram_type, &peak_bw)) {
		return 0;
	}
...
static const struct dvfsrc_opp dvfsrc_opp_mt8169_lp4[] = {
	{0, 0},	{0, 1}, {0, 2}, {0, 3},
	{1, 1}, {1, 2}, {1, 3}, {1, 4},
	{2, 1}, {2, 2}, {2, 3}, {2, 4}, {2, 5},
};

static const struct dvfsrc_opp_desc dvfsrc_opp_mt8169_desc[] = {
	DVFSRC_OPP_DESC(dvfsrc_opp_mt8169_lp4),
};

static const struct dvfsrc_soc_data mt8169_data = {
	DVFSRC_MT6873_SERIES_OPS,
	.opps_desc = dvfsrc_opp_mt8169_desc,
	.num_opp_desc = ARRAY_SIZE(dvfsrc_opp_mt8169_desc),
	.regs = mt8169_regs,
#ifdef DVFSRC_FORCE_OPP_SUPPORT
	.set_force_opp_level = mt6873_set_force_opp_level,
#endif
...
static const struct of_device_id mtk_dvfsrc_of_match[] = {
	{
		...
		.compatible = "mediatek,mt8169-dvfsrc",
		.data = &mt8169_data,
	}, {
		/* sentinel */
	},
