				...
				struct cmdq_pkt *handle)
{
	...
	if (panel_ext && panel_ext->round_corner_en) {
		...
		mtk_ddp_write_relaxed(comp, value, DISP_POSTMASK_SRAM_CFG,
				      handle);
#if IS_ENABLED(CONFIG_DRM_MEDIATEK_YOCTO)
		mtk_ddp_write_relaxed(comp, 0x210a1804, DISP_POSTMASK_NUM(0), handle);
		mtk_ddp_write_relaxed(comp, 0x15031303, DISP_POSTMASK_NUM(1), handle);
		mtk_ddp_write_relaxed(comp, 0x11030f02, DISP_POSTMASK_NUM(2), handle);
		mtk_ddp_write_relaxed(comp, 0xe030c02, DISP_POSTMASK_NUM(3), handle);
		mtk_ddp_write_relaxed(comp, 0xb020a02, DISP_POSTMASK_NUM(4), handle);
		mtk_ddp_write_relaxed(comp, 0x9020802, DISP_POSTMASK_NUM(5), handle);
		mtk_ddp_write_relaxed(comp, 0x7010601, DISP_POSTMASK_NUM(6), handle);
		mtk_ddp_write_relaxed(comp, 0x6020501, DISP_POSTMASK_NUM(7), handle);
		mtk_ddp_write_relaxed(comp, 0x5020401, DISP_POSTMASK_NUM(8), handle);
		mtk_ddp_write_relaxed(comp, 0x4020301, DISP_POSTMASK_NUM(9), handle);
		mtk_ddp_write_relaxed(comp, 0x3020201, DISP_POSTMASK_NUM(10), handle);
		mtk_ddp_write_relaxed(comp, 0x2010201, DISP_POSTMASK_NUM(11), handle);
		mtk_ddp_write_relaxed(comp, 0x1010101, DISP_POSTMASK_NUM(12), handle);
		mtk_ddp_write_relaxed(comp, 0x1010101, DISP_POSTMASK_NUM(13), handle);
		mtk_ddp_write_relaxed(comp, 0x1010101, DISP_POSTMASK_NUM(14), handle);
		mtk_ddp_write_relaxed(comp, 0x1010101, DISP_POSTMASK_NUM(15), handle);
		mtk_ddp_write_relaxed(comp, 0x1010101, DISP_POSTMASK_NUM(16), handle);

		mtk_ddp_write_relaxed(comp, 0xfedead86, DISP_POSTMASK_GRAD_VAL(0), handle);
		mtk_ddp_write_relaxed(comp, 0x634a2f1f, DISP_POSTMASK_GRAD_VAL(1), handle);
		mtk_ddp_write_relaxed(comp, 0x190df5aa, DISP_POSTMASK_GRAD_VAL(2), handle);
		mtk_ddp_write_relaxed(comp, 0x5d1ad265, DISP_POSTMASK_GRAD_VAL(3), handle);
		mtk_ddp_write_relaxed(comp, 0xdd04c01, DISP_POSTMASK_GRAD_VAL(4), handle);
		mtk_ddp_write_relaxed(comp, 0xee6403b1, DISP_POSTMASK_GRAD_VAL(5), handle);
		mtk_ddp_write_relaxed(comp, 0x16fa6d01, DISP_POSTMASK_GRAD_VAL(6), handle);
		mtk_ddp_write_relaxed(comp, 0xec3de42b, DISP_POSTMASK_GRAD_VAL(7), handle);
		mtk_ddp_write_relaxed(comp, 0xe323ec2a, DISP_POSTMASK_GRAD_VAL(8), handle);
		mtk_ddp_write_relaxed(comp, 0xf83c6aad, DISP_POSTMASK_GRAD_VAL(9), handle);
		mtk_ddp_write_relaxed(comp, 0xec1564d2, DISP_POSTMASK_GRAD_VAL(10), handle);
		mtk_ddp_write_relaxed(comp, 0x351d601, DISP_POSTMASK_GRAD_VAL(11), handle);
		mtk_ddp_write_relaxed(comp, 0x6cf811b1, DISP_POSTMASK_GRAD_VAL(12), handle);
		mtk_ddp_write_relaxed(comp, 0x631de1ad, DISP_POSTMASK_GRAD_VAL(13), handle);
		mtk_ddp_write_relaxed(comp, 0x7f5e4230, DISP_POSTMASK_GRAD_VAL(14), handle);
		mtk_ddp_write_relaxed(comp, 0x1f160d0b, DISP_POSTMASK_GRAD_VAL(15), handle);
#else
