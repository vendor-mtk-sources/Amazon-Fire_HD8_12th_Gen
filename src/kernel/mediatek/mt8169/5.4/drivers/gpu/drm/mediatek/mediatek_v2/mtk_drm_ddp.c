...
/*For MT8169*/
#define MT8169_DISP_OVL0_MOUT_EN 0xf04

#define MT8169_MMSYS_OVL_CON 0xF04

#define MT8169_DISP_RDMA2_RSZ0_RSZ1_SOUT_SEL  0xF08
	#define MT8169_RSZ0_SOUT_TO_DISP_OVL0_2L     (0)
	#define MT8169_RSZ0_SOUT_TO_DISP_OVL0        (1)
#define MT8169_DISP_REG_CONFIG_DISP_RDMA0_RSZ0_SOUT_SEL 0xF0C
	#define MT8169_RDMA0_SOUT_TO_DISP_DSI0_SEL   (0)
	#define MT8169_RDMA0_SOUT_TO_DISP_COLOR0     (1)
	#define MT8169_RDMA0_SOUT_TO_DISP_DPI0_SEL   (2)
#define MT8169_DISP_REG_CONFIG_DISP_SPR0_MOUT_EN 0xF10
	#define MT8169_SPR0_MOUT_TO_DISP_DSI0_SEL     BIT(0)
	#define MT8169_SPR0_MOUT_TO_DISP_WDMA0_SEL     BIT(1)
	#define MT8169_SPR0_MOUT_TO_DISP_DSC0_SEL     BIT(2)
#define MT8169_DISP_REG_CONFIG_DISP_TOVL0_OUT0_MOUT_EN 0xF14
	#define MT8169_OVL0_2L_MOUT_TO_DISP_RDMA0_SEL     BIT(0)
	#define MT8169_OVL0_2L_MOUT_TO_DISP_RSZ0_SEL     BIT(1)
	#define MT8169_OVL0_2L_MOUT_TO_DISP_WDMA0_SEL     BIT(2)
	#define MT8169_OVL0_2L_MOUT_TO_DISP_RDMA1_SEL     BIT(3)
#define MT8169_DISP_REG_CONFIG_DISP_TOVL0_OUT1_MOUT_EN    0xF18
	#define MT8169_OVL0_MOUT_TO_DISP_RDMA0_SEL    BIT(0)
	#define MT8169_OVL0_MOUT_TO_DISP_RSZ0_SEL    BIT(1)
	#define MT8169_OVL0_MOUT_TO_DISP_WDMA0_SEL    BIT(2)
	#define MT8169_OVL0_MOUT_TO_DISP_RDMA1_SEL    BIT(3)
#define MT8169_DISP_REG_CONFIG_DISP_RSZ0_MOUT_EN     0xF1C
	#define MT8169_RSZ0_MOUT_TO_DISP_RDMA0_SEL              BIT(0)
	#define MT8169_RSZ0_MOUT_TO_DISP_WDMA0_SEL              BIT(1)
	#define MT8169_RSZ0_MOUT_TO_DISP_RDMA2_RSZ0_RSZ1_SOUT  BIT(2)
	#define MT8169_RSZ0_MOUT_TO_DISP_RDMA1_SEL    BIT(3)
#define MT8169_DISP_REG_CONFIG_DISP_DITHER0_MOUT_EN 0xF20
	#define MT8169_DITHER0_MOUT_TO_DISP_DSI0_SEL     BIT(0)
	#define MT8169_DITHER0_MOUT_TO_DISP_WDMA0_SEL   BIT(1)
	#define MT8169_DITHER0_MOUT_TO_DISP_RDMA1_SEL    BIT(2)
	#define MT8169_DITHER0_MOUT_TO_DISP_DPI0_SEL    BIT(3)
#define MT8169_DISP_REG_CONFIG_DISP_RSZ0_SEL_IN 0xF24
	#define MT8169_RSZ0_FROM_DISP_OVL0_2L     0
	#define MT8169_RSZ0_FROM_DISP_OVL0        1
#define MT8169_DISP_REG_CONFIG_DISP_RDMA0_SEL_IN 0xF28
	#define MT8169_SEL_IN_RDMA0_FROM_DISP_OVL0     0
	#define MT8169_SEL_IN_RDMA0_FROM_DISP_RSZ0	1
	#define MT8169_SEL_IN_RDMA0_FROM_DISP_OVL0_2L  2
#define MT8169_DISP_REG_CONFIG_DSI0_SEL_IN 0xF30
	#define MT8169_SEL_IN_FROM_DISP_RDMA0_RSZ0_SOUT   0
	#define MT8169_SEL_IN_FROM_DISP_DITHER0         1
	#define MT8169_SEL_IN_FROM_DISP_RDMA1         2
#define MT8169_DISP_REG_CONFIG_DISP_WDMA0_SEL_IN 0xF34
	#define MT8169_WDMA0_SEL_IN_FROM_DISP_DITHER0        0
	#define MT8169_WDMA0_SEL_IN_FROM_DISP_RSZ0	      1
	#define MT8169_WDMA0_SEL_IN_FROM_DISP_OVL0_2L	      2
	#define MT8169_WDMA0_SEL_IN_FROM_DISP_OVL0	      3
	#define MT8169_WDMA0_SEL_IN_FROM_DISP_RDMA1	      4
#define MT8169_DISP_REG_CONFIG_DISP_RDMA1_MOUT_EN 0xF3C
	#define MT8169_RDMA1_MOUT_TO_DISP_DPI0_SEL        BIT(0)
	#define MT8169_RDMA1_MOUT_TO_DISP_WDMA0_SEL       BIT(1)
	#define MT8169_RDMA1_MOUT_TO_DISP_DSI0_SEL        BIT(2)
#define MT8169_DISP_REG_CONFIG_DISP_RDMA1_SEL_IN 0xF40
	#define MT8169_RDMA1_SEL_IN_FROM_DISP_OVL0        0
	#define MT8169_RDMA1_SEL_IN_FROM_DISP_RSZ0	   1
	#define MT8169_RDMA1_SEL_IN_FROM_DISP_OVL0_2L	   2
	#define MT8169_RDMA1_SEL_IN_FROM_DISP_DITHER0	   3
#define MT8169_DISP_REG_CONFIG_DISP_DPI0_SEL_IN 0xF44
	#define MT8169_DPI0_SEL_IN_FROM_DISP_RDMA1      0
	#define MT8169_DPI0_SEL_IN_FROM_DISP_DITHER0	 1
	#define MT8169_DPI0_SEL_IN_FROM_DISP_RDMA0	 2

#define MT8169_DISP_MUTEX0_MOD0 0x30
#define MT8169_DISP_MUTEX0_SOF 0x2C

#define MT8169_MUTEX_MOD_DISP_OVL0 BIT(0)
#define MT8169_MUTEX_MOD_DISP_OVL0_2L BIT(1)
#define MT8169_MUTEX_MOD_DISP_RDMA0 BIT(2)
#define MT8169_MUTEX_MOD_DISP_RSZ0 BIT(3)
#define MT8169_MUTEX_MOD_DISP_COLOR0 BIT(4)
#define MT8169_MUTEX_MOD_DISP_CCORR0 BIT(5)
#define MT8169_MUTEX_MOD_DISP_CCORR1 BIT(6)
#define MT8169_MUTEX_MOD_DISP_AAL0 BIT(7)
#define MT8169_MUTEX_MOD_DISP_GAMMA0 BIT(8)
#define MT8169_MUTEX_MOD_DISP_POSTMASK0 BIT(9)
#define MT8169_MUTEX_MOD_DISP_DITHER0 BIT(10)
#define MT8169_MUTEX_MOD_DISP_CM0 BIT(11)
#define MT8169_MUTEX_MOD_DISP_SPR0 BIT(12)
#define MT8169_MUTEX_MOD_DISP_DSC_WRAP0_CORE0 BIT(13)
#define MT8169_MUTEX_MOD_DISP_DSI0 BIT(14)
#define MT8169_MUTEX_MOD_DISP_WDMA0 BIT(15)
#define MT8169_MUTEX_MOD_DISP_PWM0 BIT(16)
#define MT8169_MUTEX_MOD_DISP_RDMA1 BIT(17)
#define MT8169_MUTEX_MOD_DISP_DPI0 BIT(18)

#define MT8169_MUTEX_SOF_SINGLE_MODE 0
#define MT8169_MUTEX_SOF_DSI0 1
#define MT8169_MUTEX_SOF_DPI0 2
#define MT8169_MUTEX_EOF_DSI0 (MT8169_MUTEX_SOF_DSI0 << 6)
#define MT8169_MUTEX_EOF_DPI0 (MT8169_MUTEX_SOF_DPI0 << 6)
...
static const unsigned int mt8169_mutex_mod[DDP_COMPONENT_ID_MAX] = {
		[DDP_COMPONENT_OVL0] = MT8169_MUTEX_MOD_DISP_OVL0,
		[DDP_COMPONENT_OVL0_2L] = MT8169_MUTEX_MOD_DISP_OVL0_2L,
		[DDP_COMPONENT_RDMA0] = MT8169_MUTEX_MOD_DISP_RDMA0,
		[DDP_COMPONENT_RSZ0] = MT8169_MUTEX_MOD_DISP_RSZ0,
		[DDP_COMPONENT_COLOR0] = MT8169_MUTEX_MOD_DISP_COLOR0,
		[DDP_COMPONENT_CCORR0] = MT8169_MUTEX_MOD_DISP_CCORR0,
		[DDP_COMPONENT_CCORR1] = MT8169_MUTEX_MOD_DISP_CCORR1,
		[DDP_COMPONENT_AAL0] = MT8169_MUTEX_MOD_DISP_AAL0,
		[DDP_COMPONENT_GAMMA0] = MT8169_MUTEX_MOD_DISP_GAMMA0,
		[DDP_COMPONENT_POSTMASK0] = MT8169_MUTEX_MOD_DISP_POSTMASK0,
		[DDP_COMPONENT_DITHER0] = MT8169_MUTEX_MOD_DISP_DITHER0,
		[DDP_COMPONENT_CM0] = MT8169_MUTEX_MOD_DISP_CM0,
		[DDP_COMPONENT_SPR0] = MT8169_MUTEX_MOD_DISP_SPR0,
		[DDP_COMPONENT_DSC0] = MT8169_MUTEX_MOD_DISP_DSC_WRAP0_CORE0,
		[DDP_COMPONENT_DSI0] = MT8169_MUTEX_MOD_DISP_DSI0,
		[DDP_COMPONENT_WDMA0] = MT8169_MUTEX_MOD_DISP_WDMA0,
		[DDP_COMPONENT_PWM0] = MT8169_MUTEX_MOD_DISP_PWM0,
		[DDP_COMPONENT_RDMA1] = MT8169_MUTEX_MOD_DISP_RDMA0,
		[DDP_COMPONENT_DPI0] = MT8169_MUTEX_MOD_DISP_RDMA0,
};
...
static const unsigned int mt8169_mutex_sof[DDP_MUTEX_SOF_MAX] = {
		[DDP_MUTEX_SOF_SINGLE_MODE] = MT8169_MUTEX_SOF_SINGLE_MODE,
		[DDP_MUTEX_SOF_DSI0] =
			MT8169_MUTEX_SOF_DSI0 | MT8169_MUTEX_EOF_DSI0,
		[DDP_MUTEX_SOF_DPI0] =
			MT8169_MUTEX_SOF_DPI0 | MT8169_MUTEX_EOF_DPI0,
};
...
static const struct mtk_disp_ddp_data mt8169_ddp_driver_data = {
	.mutex_mod = mt8169_mutex_mod,
	.mutex_sof = mt8169_mutex_sof,
	.mutex_mod_reg = MT8169_DISP_MUTEX0_MOD0,
	.mutex_sof_reg = MT8169_DISP_MUTEX0_SOF,
};
...
const struct mtk_mmsys_reg_data mt8169_mmsys_reg_data = {
	.ovl0_mout_en = MT8169_DISP_OVL0_MOUT_EN,
	.rdma0_sout_sel_in = MT8169_DISP_REG_CONFIG_DISP_RDMA0_RSZ0_SOUT_SEL,
	.rdma0_sout_color0 = MT8169_RDMA0_SOUT_TO_DISP_COLOR0,
	.dpi0_sel_in = MT8169_DISP_REG_CONFIG_DISP_DPI0_SEL_IN,
	.dpi0_sel_in_rdma1 = MT8169_DPI0_SEL_IN_FROM_DISP_RDMA1,
};
...
static char *ddp_signal_0_mt8169(int bit)
{
	switch (bit) {
	case 0:
		return
			"DISP_AAL0_TO_DISP_GAMMA0 VALID";
	case 1:
		return
			"DISP_CCORR0_TO_DISP_AAL0 VALID";
	case 2:
		return
			"DISP_COLOR0_TO_DISP_CCORR0 VALID";
	case 3:
		return
			"DISP_DITHER0_TO_DISP_DITHER0_MOUT VALID";
	case 4:
		return
			"DISP_DITHER0_MOUT_OUT0_TO_DSI0_SEL_IN1 VALID";
	case 5:
		return
			"DISP_DITHER0_MOUT_OUT1_TO_DISP_WDMA0_SEL_IN0 VALID";
	case 6:
		return
			"DISP_DITHER0_MOUT_OUT0_TO_DISP_DSC_WRAP0 VALID";
	case 7:
		return
			"DISP_GAMMA0_TO_DISP_POSTMASK0 VALID";
	case 8:
		return
			"DISP_OVL0_2L_OUT0_TO_DISP_TOVL0_OUT0_MOUT VALID";
	case 9:
		return
			"DISP_OVL0_2L_OUT1_TO_DISP_OVL0_IN0 VALID";
	case 10:
		return
			"DISP_OVL0_OUT0_TO_DISP_TOVL0_OUT1_MOUT VALID";
	case 11:
		return
			"disp_ovl0_out1_to_disp_ovl0_2l_in0 VALID";
	case 12:
		return
			"DISP_POSTMASK0_TO_DISP_DITHER0 VALID";
	case 13:
		return
			"disp_rdma0_to_disp_rdma0_rsz0_sout VALID";
	case 14:
		return
			"disp_rdma0_rsz0_sout_out0_to_dsi0_sel_in0 VALID";
	case 15:
		return
			"disp_rdma0_rsz0_sout_out1_to_disp_color0 VALID";
	case 16:
		return
			"disp_rdma0_sel_to_disp_rdma0 VALID";
	case 17:
		return
			"disp_rdma2_rsz0_rsz1_sout_out0_to_disp_ovl0_2l_in2 VALID";
	case 18:
		return
			"disp_rdma2_rsz0_rsz1_sout_out1_to_disp_ovl0_in2 VALID";
	case 19:
		return
			"disp_rsz0_to_disp_rsz0_mout VALID";
	case 20:
		return
			"disp_rsz0_mout_out0_to_disp_rdma0_sel_in1 VALID";
	case 21:
		return
			"disp_rsz0_mout_out1_to_disp_wdma0_sel_in1 VALID";
	case 22:
		return
			"disp_rsz0_mout_out2_to_disp_rdma2_rsz0_rsz1_sout VALID";
	case 23:
		return
			"disp_rsz0_sel_to_disp_rsz0 VALID";
	case 24:
		return
			"disp_tovl0_out0_mout_out0_to_disp_rdma0_sel_in2 VALID";
	case 25:
		return
			"disp_tovl0_out0_mout_out1_to_disp_rsz0_sel_in0 VALID";
	case 26:
		return
			"disp_tovl0_out0_mout_out2_to_disp_wdma0_sel_in2 VALID";
	case 27:
		return
			"disp_tovl0_out1_mout_out0_to_disp_rdma0_sel_in0 VALID";
	case 28:
		return
			"disp_tovl0_out1_mout_out1_to_disp_rsz0_sel_in1 VALID";
	case 29:
		return
			"disp_tovl0_out1_mout_out2_to_disp_wdma0_sel_in3 VALID";
	case 30:
		return
			"disp_wdma0_sel_to_disp_wdma0 VALID";
	case 31:
		return
			"dsi0_sel_to_thp_lmt_dsi0 VALID";
	default:
		return NULL;
	}
}

static char *ddp_signal_1_mt8169(int bit)
{
	switch (bit) {
	case 0:
		return
			"thp_lmt_dsi0__to__dsi0 VALID";
	case 1:
		return
			"disp_dsc_wrap0_mout_out0_to_disp_wdma0_sel_in4 VALID";
	case 2:
		return
			"disp_dsc_wrap0_mout_out1_to_dsi0_sel_in2 VALID";
	default:
		return NULL;
	}
}
...
static char *ddp_greq_name_larb0_mt8169(int bit)
{
	switch (bit) {
	case 0:
		return "DISP_POSTMASK0 ";
...
static char *ddp_greq_name_larb1_mt8169(int bit)
{
	switch (bit) {
	case 0:
		return "DISP_RDMA1 ";
...
static char *ddp_get_mutex_module0_name_mt8169(unsigned int bit)
{
	switch (bit) {
	case 0:
		return "disp_ovl0";
...
char *mtk_ddp_get_mutex_sof_name_mt8169(unsigned int regval)
{
	switch (regval) {
	case MUTEX_SOF_SINGLE_MODE:
		return "single";
...
static char *ddp_clock_0_mt8169(int bit)
{
	switch (bit) {
	case 0:
		return "disp_mutex0, ";
...
static int mtk_ddp_mout_en_MT8169(const struct mtk_mmsys_reg_data *data,
			   enum mtk_ddp_comp_id cur, enum mtk_ddp_comp_id next,
			   unsigned int *addr)
{
	int value;
	...
	if (cur == DDP_COMPONENT_OVL0_2L &&
		next == DDP_COMPONENT_RDMA0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_TOVL0_OUT0_MOUT_EN;
		value = MT8169_OVL0_2L_MOUT_TO_DISP_RDMA0_SEL;
	} else if (cur == DDP_COMPONENT_OVL0_2L &&
		next == DDP_COMPONENT_RSZ0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_TOVL0_OUT0_MOUT_EN;
		value = MT8169_OVL0_2L_MOUT_TO_DISP_RSZ0_SEL;
	} else if (cur == DDP_COMPONENT_OVL0_2L &&
		next == DDP_COMPONENT_WDMA0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_TOVL0_OUT0_MOUT_EN;
		value = MT8169_OVL0_2L_MOUT_TO_DISP_WDMA0_SEL;
	} else if (cur == DDP_COMPONENT_OVL0_2L &&
		next == DDP_COMPONENT_RDMA1) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_TOVL0_OUT0_MOUT_EN;
		value = MT8169_OVL0_2L_MOUT_TO_DISP_RDMA1_SEL;
	} else if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_RDMA0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_TOVL0_OUT1_MOUT_EN;
		value = MT8169_OVL0_MOUT_TO_DISP_RDMA0_SEL;
	} else if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_RSZ0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_TOVL0_OUT1_MOUT_EN;
		value = MT8169_OVL0_MOUT_TO_DISP_RSZ0_SEL;
	} else if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_WDMA0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_TOVL0_OUT1_MOUT_EN;
		value = MT8169_OVL0_MOUT_TO_DISP_WDMA0_SEL;
	} else if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_RDMA1) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_TOVL0_OUT1_MOUT_EN;
		value = MT8169_OVL0_MOUT_TO_DISP_RDMA1_SEL;
	} else if (cur == DDP_COMPONENT_RSZ0 &&
		next == DDP_COMPONENT_RDMA0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_RSZ0_MOUT_EN;
		value = MT8169_RSZ0_MOUT_TO_DISP_RDMA0_SEL;
	} else if (cur == DDP_COMPONENT_RSZ0 &&
		next == DDP_COMPONENT_WDMA0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_RSZ0_MOUT_EN;
		value = MT8169_RSZ0_MOUT_TO_DISP_WDMA0_SEL;
	} else if (cur == DDP_COMPONENT_RSZ0 &&
		next == DDP_COMPONENT_UFOE) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_RSZ0_MOUT_EN;
		value = MT8169_RSZ0_MOUT_TO_DISP_RDMA2_RSZ0_RSZ1_SOUT;
	} else if (cur == DDP_COMPONENT_RSZ0 &&
		next == DDP_COMPONENT_RDMA1) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_RSZ0_MOUT_EN;
		value = MT8169_RSZ0_MOUT_TO_DISP_RDMA1_SEL;
	/*DISP_DITHER0_MOUT*/
	} else if (cur == DDP_COMPONENT_DITHER0 &&
		next == DDP_COMPONENT_DSI0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_DITHER0_MOUT_EN;
		value = MT8169_DITHER0_MOUT_TO_DISP_DSI0_SEL;
	} else if (cur == DDP_COMPONENT_DITHER0 &&
		next == DDP_COMPONENT_WDMA0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_DITHER0_MOUT_EN;
		value = MT8169_DITHER0_MOUT_TO_DISP_WDMA0_SEL;
	} else if (cur == DDP_COMPONENT_DITHER0 &&
		next == DDP_COMPONENT_RDMA1) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_DITHER0_MOUT_EN;
		value = MT8169_DITHER0_MOUT_TO_DISP_RDMA1_SEL;
	} else if (cur == DDP_COMPONENT_DITHER0 &&
		next == DDP_COMPONENT_DPI0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_DITHER0_MOUT_EN;
		value = MT8169_DITHER0_MOUT_TO_DISP_DPI0_SEL;
	} else if (cur == DDP_COMPONENT_RDMA1 &&
		next == DDP_COMPONENT_DPI0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_RDMA1_MOUT_EN;
		value = MT8169_RDMA1_MOUT_TO_DISP_DPI0_SEL;
	} else if (cur == DDP_COMPONENT_RDMA1 &&
		next == DDP_COMPONENT_WDMA0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_RDMA1_MOUT_EN;
		value = MT8169_RDMA1_MOUT_TO_DISP_WDMA0_SEL;
	} else if (cur == DDP_COMPONENT_RDMA1 &&
		next == DDP_COMPONENT_DSI0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_RDMA1_MOUT_EN;
		value = MT8169_RDMA1_MOUT_TO_DISP_DSI0_SEL;
	/*No cur or next component*/
	} else {
		value = -1;
	}
...
static int mtk_ddp_sel_in_MT8169(const struct mtk_mmsys_reg_data *data,
			  enum mtk_ddp_comp_id cur, enum mtk_ddp_comp_id next,
			  unsigned int *addr)
{
	int value;
	...
	if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_RDMA0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_RDMA0_SEL_IN;
		value = MT8169_SEL_IN_RDMA0_FROM_DISP_OVL0;
	} else if (cur == DDP_COMPONENT_RSZ0 &&
		next == DDP_COMPONENT_RDMA0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_RDMA0_SEL_IN;
		value = MT8169_SEL_IN_RDMA0_FROM_DISP_RSZ0;
	} else if (cur == DDP_COMPONENT_OVL0_2L &&
		next == DDP_COMPONENT_RDMA0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_RDMA0_SEL_IN;
		value = MT8169_SEL_IN_RDMA0_FROM_DISP_OVL0_2L;
	/*DISP_DSI0_SEL*/
	} else if (cur == DDP_COMPONENT_RDMA0 &&
		next == DDP_COMPONENT_DSI0) {
		*addr = MT8169_DISP_REG_CONFIG_DSI0_SEL_IN;
		value = MT8169_SEL_IN_FROM_DISP_RDMA0_RSZ0_SOUT;
	} else if (cur == DDP_COMPONENT_DITHER0 &&
		next == DDP_COMPONENT_DSI0) {
		*addr = MT8169_DISP_REG_CONFIG_DSI0_SEL_IN;
		value = MT8169_SEL_IN_FROM_DISP_DITHER0;
	} else if (cur == DDP_COMPONENT_RDMA1 &&
		next == DDP_COMPONENT_DSI0) {
		*addr = MT8169_DISP_REG_CONFIG_DSI0_SEL_IN;
		value = MT8169_SEL_IN_FROM_DISP_RDMA1;
	/*DISP_WDMA0_SEL*/
	} else if (cur == DDP_COMPONENT_DITHER0 &&
		next == DDP_COMPONENT_WDMA0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_WDMA0_SEL_IN;
		value = MT8169_WDMA0_SEL_IN_FROM_DISP_DITHER0;
	} else if (cur == DDP_COMPONENT_RSZ0 &&
		next == DDP_COMPONENT_WDMA0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_WDMA0_SEL_IN;
		value = MT8169_WDMA0_SEL_IN_FROM_DISP_RSZ0;
	} else if (cur == DDP_COMPONENT_OVL0_2L &&
		next == DDP_COMPONENT_WDMA0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_WDMA0_SEL_IN;
		value = MT8169_WDMA0_SEL_IN_FROM_DISP_OVL0_2L;
	} else if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_WDMA0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_WDMA0_SEL_IN;
		value = MT8169_WDMA0_SEL_IN_FROM_DISP_OVL0;
	} else if (cur == DDP_COMPONENT_RDMA1 &&
		next == DDP_COMPONENT_WDMA0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_WDMA0_SEL_IN;
		value = MT8169_WDMA0_SEL_IN_FROM_DISP_RDMA1;
	/*DISP_RSZ0_SEL*/
	} else if (cur == DDP_COMPONENT_OVL0_2L &&
		next == DDP_COMPONENT_RSZ0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_RSZ0_SEL_IN;
		value = MT8169_RSZ0_FROM_DISP_OVL0_2L;
	} else if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_RSZ0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_RSZ0_SEL_IN;
		value = MT8169_RSZ0_FROM_DISP_OVL0;
	} else if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_RDMA1) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_RDMA1_SEL_IN;
		value = MT8169_RDMA1_SEL_IN_FROM_DISP_OVL0;
	} else if (cur == DDP_COMPONENT_RSZ0 &&
		next == DDP_COMPONENT_RDMA1) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_RDMA1_SEL_IN;
		value = MT8169_RDMA1_SEL_IN_FROM_DISP_RSZ0;
	} else if (cur == DDP_COMPONENT_OVL0_2L &&
		next == DDP_COMPONENT_RDMA1) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_RDMA1_SEL_IN;
		value = MT8169_RDMA1_SEL_IN_FROM_DISP_OVL0_2L;
	} else if (cur == DDP_COMPONENT_DITHER0 &&
		next == DDP_COMPONENT_RDMA1) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_RDMA1_SEL_IN;
		value = MT8169_RDMA1_SEL_IN_FROM_DISP_DITHER0;
	/*No cur or next component*/
	} else {
		value = -1;
	}
...
static int mtk_ddp_sout_sel_MT8169(const struct mtk_mmsys_reg_data *data,
			    enum mtk_ddp_comp_id cur, enum mtk_ddp_comp_id next,
			    unsigned int *addr)
{
	int value;
	...
	if (cur == DDP_COMPONENT_RSZ0 &&
		next == DDP_COMPONENT_OVL0_2L) {
		*addr = MT8169_DISP_RDMA2_RSZ0_RSZ1_SOUT_SEL;
		value = MT8169_RSZ0_SOUT_TO_DISP_OVL0_2L;
	} else if (cur == DDP_COMPONENT_RSZ0 &&
		next == DDP_COMPONENT_OVL0) {
		*addr = MT8169_DISP_RDMA2_RSZ0_RSZ1_SOUT_SEL;
		value = MT8169_RSZ0_SOUT_TO_DISP_OVL0;
	/*DISP_RDMA0_RSZ0_SOUT*/
	} else if (cur == DDP_COMPONENT_RDMA0 &&
		next == DDP_COMPONENT_DSI0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_RDMA0_RSZ0_SOUT_SEL;
		value = MT8169_RDMA0_SOUT_TO_DISP_DSI0_SEL;
	} else if (cur == DDP_COMPONENT_RDMA0 &&
		next == DDP_COMPONENT_COLOR0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_RDMA0_RSZ0_SOUT_SEL;
		value = MT8169_RDMA0_SOUT_TO_DISP_COLOR0;
	} else if (cur == DDP_COMPONENT_RDMA0 &&
		next == DDP_COMPONENT_DPI0) {
		*addr = MT8169_DISP_REG_CONFIG_DISP_RDMA0_RSZ0_SOUT_SEL;
		value = MT8169_RDMA0_SOUT_TO_DISP_DPI0_SEL;
	/*No cur or next component*/
	} else {
		value = -1;
	}
...
static int mtk_ddp_ovl_bg_blend_en_MT8169(const struct mtk_mmsys_reg_data *data,
			   enum mtk_ddp_comp_id cur, enum mtk_ddp_comp_id next,
			   unsigned int *addr)
{
	int value;
			      ...
			      enum mtk_ddp_comp_id next)
{
	...
	case MMSYS_MT6853:
		...
		break;
	case MMSYS_MT8169:
		value = mtk_ddp_mout_en_MT8169(reg_data, cur, next, &addr);
		if (value >= 0) {
			reg = readl_relaxed(config_regs + addr) | value;
			writel_relaxed(reg, config_regs + addr);
		}

		value = mtk_ddp_sout_sel_MT8169(reg_data, cur, next, &addr);
		if (value >= 0)
			writel_relaxed(value, config_regs + addr);

		value = mtk_ddp_sel_in_MT8169(reg_data, cur, next, &addr);
		if (value >= 0)
			writel_relaxed(value, config_regs + addr);

		value = mtk_ddp_ovl_bg_blend_en_MT8169(
			reg_data, cur, next, &addr);
		if (value >= 0) {
			reg = readl_relaxed(config_regs + addr) | value;
			writel_relaxed(reg, config_regs + addr);
					...
					struct cmdq_pkt *handle)
{
	...
	case MMSYS_MT6853:
		...
		break;
	case MMSYS_MT8169:
		value = mtk_ddp_mout_en_MT8169(mtk_crtc->mmsys_reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				mtk_crtc->config_regs_pa
		...
		value = mtk_ddp_sout_sel_MT8169(mtk_crtc->mmsys_reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				mtk_crtc->config_regs_pa
		...
		value = mtk_ddp_sel_in_MT8169(mtk_crtc->mmsys_reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				mtk_crtc->config_regs_pa
		...
		value = mtk_ddp_ovl_bg_blend_en_MT8169(mtk_crtc->mmsys_reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				mtk_crtc->config_regs_pa
				   ...
				   enum mtk_ddp_comp_id next)
{
	...
	case MMSYS_MT8169:
		...
		value = mtk_ddp_ovl_bg_blend_en_MT8169(reg_data, cur, next, &addr);
		if (value >= 0) {
			reg = readl_relaxed(config_regs + addr) & ~(unsigned int)value;
			writel_relaxed(reg, config_regs + addr);
		}
...
void mutex_dump_analysis_mt8169(struct mtk_disp_mutex *mutex)
{
	...
	for (i = 0; i < 5; i++) {
		...
		for (j = 0; j < 32; j++) {
			...
			if ((regval & (1 << j))) {
				len = sprintf(p, "%s,",
					ddp_get_mutex_module0_name_mt8169(j));
				if (len >= 0)
					p += len;
			}
		}
...
void mmsys_config_dump_analysis_mt8169(void __iomem *config_regs)
{
	...
	for (i = 0; i < 32; i++) {
		if (greq0 & (1 << i)) {
			name = ddp_greq_name_larb0_mt8169(i);
			if (!name)
				continue;
			strncat(clock_on, name,
				(sizeof(clock_on) -
	...
	for (i = 0; i < 32; i++) {
		if (greq1 & (1 << i)) {
			name = ddp_greq_name_larb1_mt8169(i);
			if (!name)
				continue;
			strncat(clock_on, name,
				(sizeof(clock_on) -
