...
#define mtk_icc_node_create(id)			(ERR_PTR(-EOPNOTSUPP))
#define mtk_icc_node_destroy(id)
#define mtk_icc_link_create(node, dst_id)	(-EOPNOTSUPP)
#define mtk_icc_link_destroy(src, dst)		(-EOPNOTSUPP)
#define mtk_icc_node_add(node, provider)
#define mtk_icc_node_del(node)
#define mtk_icc_provider_add(provider)		(-EOPNOTSUPP)
#define mtk_icc_provider_del(provider)		(-EOPNOTSUPP)
