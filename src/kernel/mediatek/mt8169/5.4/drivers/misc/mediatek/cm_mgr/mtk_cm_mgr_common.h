...
struct cm_mgr_hook {
	u32 (*cm_mgr_get_perfs)(int val);
	void (*cm_mgr_perf_set_force_status)(int val);
	void (*check_cm_mgr_status)(unsigned int val1, unsigned int val2, unsigned int val3);
	void (*cm_mgr_perf_platform_set_status)(int val);
	void (*cm_mgr_perf_set_status)(int val);
};
...
#define IPI_CM_MGR_CPUFREQ_TABLE_INDEX 35
