 ...
 * Filename:
 * ---------
 *	 hi556_raspite_raw_hlt_rear_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "hi556_raspite_raw_hlt_rear_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI556_RASPITE_HLT_REAR_SENSOR_ID,
	...
	.hs_video = {
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.max_framerate = 300,
		.mipi_pixel_rate = 44000000,//880M x 2 / 10
	},
	.slim_video = {
		.pclk = 176000000,
		.linelength = 2564,
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.max_framerate = 300,
		.mipi_pixel_rate = 176000000,//220M x 2 / 10
	},
	.custom1 = {
		.pclk = 176000000,
		.linelength = 2816,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
 ...
 { 2608, 1960,	0,	  4,   2608, 1952,	 1304,  976,   4, 2, 1296,	972,   0, 0, 1296,	972}, 	// preview
 { 2608, 1960,  0,    6,   2608, 1948,   2608, 1948,   8, 2, 2592, 1944,   0, 0, 2592, 1944}, 	// capture
 { 2608, 1960,  0,    6,   2608, 1948,   2608, 1948,   8, 2, 2592, 1944,   0, 0, 2592, 1944}, 	// video
 { 2608, 1960, 0, 496, 2608, 968, 1304, 484, 332, 2, 640, 480, 0, 0, 640, 480},	 // high speed video
 { 2608, 1960, 0, 438, 2608, 1084, 2608, 1084, 344, 2, 1920, 1080, 0, 0, 1920, 1080}, // slim video
 { 2608, 1960, 0, 256, 2608, 1448, 1304, 724, 12, 2, 1280, 720, 0, 0, 1280, 720}, // custom1
 { 2608, 1960, 0, 16, 2608, 1928, 1304, 964, 12, 2, 1280, 960, 0, 0, 1280, 960}, // custom2
 { 2608, 1960, 0, 16, 2608, 1928, 1304, 964, 12, 2, 1280, 960, 0, 0, 1280, 960}, // custom3
 { 2608, 1960, 0, 16, 2608, 1928, 1304, 964, 12, 2, 1280, 960, 0, 0, 1280, 960}, // custom4
 { 2608, 1960, 0, 496, 2608, 968, 1304, 484, 332, 2, 640, 480, 0, 0, 640, 480},  // custom5
};
...
kal_uint16 addr_data_pair_custom1_hi556[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7167,
	0x004a, 0x0100,
...
{
	hi556_table_write_cmos_sensor(
		addr_data_pair_custom1_hi556,
		sizeof(addr_data_pair_custom1_hi556) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_custom2_hi556[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7167,
	0x004a, 0x0100,
...
{
	hi556_table_write_cmos_sensor(
		addr_data_pair_custom2_hi556,
		sizeof(addr_data_pair_custom2_hi556) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_custom3_hi556[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7167,
	0x004a, 0x0100,
...
{
	hi556_table_write_cmos_sensor(
		addr_data_pair_custom3_hi556,
		sizeof(addr_data_pair_custom3_hi556) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_custom4_hi556[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7167,
	0x004a, 0x0100,
...
{
	hi556_table_write_cmos_sensor(
		addr_data_pair_custom4_hi556,
		sizeof(addr_data_pair_custom4_hi556) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_custom5_hi556[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7267,
	0x004a, 0x0100,
...
{
	hi556_table_write_cmos_sensor(
		addr_data_pair_custom5_hi556,
		sizeof(addr_data_pair_custom5_hi556) /
		sizeof(kal_uint16));
}
	...
	MSDK_SENSOR_INFO_STRUCT *sensor_info, MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	sensor_info->HighSpeedVideoDelayFrame = imgsensor_info.slim_video_delay_frame;
	...
	sensor_info->SlimVideoDelayFrame = imgsensor_info.custom3_delay_frame;
	sensor_info->SlimVideoDelayFrame = imgsensor_info.custom4_delay_frame;
	sensor_info->SlimVideoDelayFrame = imgsensor_info.custom5_delay_frame;
...
UINT32 HI556_RASPITE_HLT_REAR_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
