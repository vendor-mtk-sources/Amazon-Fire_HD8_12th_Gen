...
static const struct qos_sram_addr mt6873_qos_sram_pin[] = {
	...
	[CM_CPUFREQ_L_VROC_TABLE] = {
			.offset = 0xD0,
			.valid = true,
		},
	[CM_CPUFREQ_L_FREQ_TABLE] = {
			.offset = 0xD4,
			.valid = true,
		},
	[CM_CPUFREQ_L_CUR_VPROC] = {
			.offset = 0xD8,
			.valid = true,
		},
	[CM_CPUFREQ_L_CUR_FREQ] = {
			.offset = 0xDC,
			.valid = true,
		},
	[CM_CPUFREQ_L_CUR_FREQ_OPP] = {
			.offset = 0xE0,
			.valid = true,
		},
	[CM_CPUFREQ_B_VROC_TABLE] = {
			.offset = 0xE4,
			.valid = true,
		},
	[CM_CPUFREQ_B_FREQ_TABLE] = {
			.offset = 0xE8,
			.valid = true,
		},
	[CM_CPUFREQ_B_CUR_VPROC] = {
			.offset = 0xEC,
			.valid = true,
		},
	[CM_CPUFREQ_B_CUR_FREQ] = {
			.offset = 0xF0,
			.valid = true,
		},
	[CM_CPUFREQ_B_CUR_FREQ_OPP] = {
			.offset = 0xF4,
			.valid = true,
		},
	[CM_CPUFREQ_ONLINE] = {
...
static const struct of_device_id mtk_qos_of_match[] = {
	{
		...
		.compatible = "mediatek,mt8169-qos",
		.data = &mt6873_qos_data,
	}, {
		/* sentinel */
	},
