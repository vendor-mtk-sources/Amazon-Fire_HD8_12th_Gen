 ...
 * Filename:
 * ---------
 *     sc201cs_raspite_raw_lce_rear_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "sc201cs_raspite_raw_lce_rear_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "sc201cs_raspite_lce_rear_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = SC201CS_RASPITE_LCE_REAR_SENSOR_ID,
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	for (gain_index = SC201CS_SENSOR_GAIN_MAX_VALID_INDEX - 1; gain_index >= 1; gain_index--)
	...
	LOG_INF("SC201CS_AGC_Param[gain_index][1] = 0x%x, temp_gain = 0x%x, reg_gain = %d\n",
		SC201CS_AGC_Param[gain_index][1], temp_gain, reg_gain);
...
{
	LOG_INF("E:preview_setting\n");
	write_cmos_sensor(0x0100,0x01);
}

static void capture_setting(void)
{
	LOG_INF("E:capture_setting\n");
	write_cmos_sensor(0x0100,0x01);
}

static void normal_video_setting(void)
{
	LOG_INF("E:normal_video_setting\n");
	write_cmos_sensor(0x0100,0x01);
}
...
UINT32 SC201CS_RASPITE_LCE_REAR_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
