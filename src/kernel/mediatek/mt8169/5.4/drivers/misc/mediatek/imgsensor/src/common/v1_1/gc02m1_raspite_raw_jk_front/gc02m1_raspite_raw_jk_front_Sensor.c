 ...
 * Filename:
 * ---------
 *    gc02m1_raspite_raw_jk_front_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "gc02m1_raspite_raw_jk_front_Sensor.h"

/************* Modify Following Strings for Debug ****************/
#define PFX "gc02m1_raspite_jk_front_camera_sensor"
#define LOG_1 LOG_INF("gc02m1_raspite_jk_front_camera_sensor, MIPI 1LANE\n")
/********************** Modify end  ******************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1_RASPITE_JK_FRONT_SENSOR_ID,
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x27, 0x09);

	write_cmos_sensor(0x36, 0x01);
	write_cmos_sensor(0x37, 0x01);
...
UINT32 GC02M1_RASPITE_JK_FRONT_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
