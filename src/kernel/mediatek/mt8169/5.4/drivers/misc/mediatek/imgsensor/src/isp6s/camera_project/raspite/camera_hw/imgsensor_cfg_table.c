...
#endif
#if defined(GC2375HSUB_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC2375HSUB_MIPI_RAW,
		{
			{PDN, Vol_High, 1},
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 5},
...
#endif
#if defined(GC02M1_RASPITE_RAW_CXT_REAR)
	{
		SENSOR_DRVNAME_GC02M1_RASPITE_RAW_CXT_REAR,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 5},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(OV02B10_RASPITE_RAW_CXT_FRONT)
	{
		SENSOR_DRVNAME_OV02B10_RASPITE_RAW_CXT_FRONT,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 5},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(GC02M1_RASPITE_RAW_JK_REAR)
	{
		SENSOR_DRVNAME_GC02M1_RASPITE_RAW_JK_REAR,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 5},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(GC02M1_RASPITE_RAW_JK_FRONT)
	{
		SENSOR_DRVNAME_GC02M1_RASPITE_RAW_JK_FRONT,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 5},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(OV02B10_RASPITE_RAW_SJC_REAR)
	{
		SENSOR_DRVNAME_OV02B10_RASPITE_RAW_SJC_REAR,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 5},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(OV02B10_RASPITE_RAW_SJC_FRONT)
	{
		SENSOR_DRVNAME_OV02B10_RASPITE_RAW_SJC_FRONT,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 5},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(GC5035_RASPITE_RAW_LCE_REAR)
	{
		SENSOR_DRVNAME_GC5035_RASPITE_RAW_LCE_REAR,
		{
			{SensorMCLK, Vol_High, 2},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_High, 1},
...
#endif
#if defined(HI556_RASPITE_RAW_HLT_REAR)
	{
		SENSOR_DRVNAME_HI556_RASPITE_RAW_HLT_REAR,
		{
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
			{DVDD, Vol_High, 1},
