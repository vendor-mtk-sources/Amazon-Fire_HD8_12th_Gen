...
static struct dvfsrc_opp dvfsrc_opp_mt8169_lp4[] = {
	{0, 0, 0, 0},
	{0, 1, 0, 0},
	{0, 2, 0, 0},
	{0, 3, 0, 0},
...
static struct dvfsrc_opp_desc dvfsrc_opp_mt8169_desc[] = {
	MT_DVFSRC_OPP(3, 6, dvfsrc_opp_mt8169_lp4),
};

static const struct dvfsrc_debug_data mt8169_data = {
	.version = 0x8169,
	.config = &mt6873_dvfsrc_config,
