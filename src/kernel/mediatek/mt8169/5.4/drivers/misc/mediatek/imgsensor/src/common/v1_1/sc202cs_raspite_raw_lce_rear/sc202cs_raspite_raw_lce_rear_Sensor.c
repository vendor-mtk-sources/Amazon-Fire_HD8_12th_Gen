 ...
 * Filename:
 * ---------
 *     sc202cs_raspite_raw_lce_rear_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "sc202cs_raspite_raw_lce_rear_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "sc202cs_raspite_lce_rear_camera_sensor"
...
kal_bool SC202CSDuringTestPattern = KAL_FALSE;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = SC202CS_RASPITE_LCE_REAR_SENSOR_ID,
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	LOG_INF("SC202CS_AGC_Param[gain_index][1] = 0x%x, temp_gain = 0x%x, reg_gain = %d\n",
		SC202CS_AGC_Param[gain_index][1], temp_gain, reg_gain);
...
kal_uint16 addr_data_pair_init_sc202cs[] = {
	//;==================INI==================
...
kal_uint16 addr_data_pair_preview_sc202cs[] = {
	0x0100,0x01,
};

kal_uint16 addr_data_pair_capture_sc202cs[] = {
	0x0100,0x01,
};

kal_uint16 addr_data_pair_normal_video_sc202cs[] = {
	0x0100,0x01,
};

kal_uint16 addr_data_pair_hs_video_sc202cs[] = {
	0x0100,0x01,
};

kal_uint16 addr_data_pair_slim_video_sc202cs[] = {
	0x0100,0x01,
};
...
static void sensor_init(void)
{
	...
	sc202cs_table_write_cmos_sensor(
	    addr_data_pair_init_sc202cs,
		sizeof(addr_data_pair_init_sc202cs) /
		sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	sc202cs_table_write_cmos_sensor(
		addr_data_pair_preview_sc202cs,
		sizeof(addr_data_pair_preview_sc202cs) /
		sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	sc202cs_table_write_cmos_sensor(
		addr_data_pair_capture_sc202cs,
		sizeof(addr_data_pair_capture_sc202cs) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	sc202cs_table_write_cmos_sensor(
	    addr_data_pair_normal_video_sc202cs,
		sizeof(addr_data_pair_normal_video_sc202cs) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	sc202cs_table_write_cmos_sensor(
		addr_data_pair_hs_video_sc202cs,
		sizeof(addr_data_pair_hs_video_sc202cs) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	sc202cs_table_write_cmos_sensor(
		addr_data_pair_slim_video_sc202cs,
		sizeof(addr_data_pair_slim_video_sc202cs) /
		sizeof(kal_uint16));
}
...
static kal_uint32 open(void)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	SC202CSDuringTestPattern = KAL_FALSE;
	return ERROR_NONE;
}
...
UINT32 SC202CS_RASPITE_LCE_REAR_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
