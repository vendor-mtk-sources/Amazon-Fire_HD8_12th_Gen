...
static const u32 PMIC_CLKBUF_MASK[REG_NUM] = {
	[XO1_MODE] = 0x3,
	[XO1_EN_M] = 0x1,
	[XO1_ISET_M] = 0x3,
	...
	[XO2_EN_M] = 0x1,
	[XO2_ISET_M] = 0x3,
	[XO2_BBLPM_EN_MSK] = 0x1,
	[XO3_MODE] = 0x3,
	[XO3_EN_M] = 0x1,
	[XO3_ISET_M] = 0x3,
	[XO3_BBLPM_EN_MSK] = 0x1,
	[XO4_MODE] = 0x3,
	[XO4_EN_M] = 0x1,
	[XO4_ISET_M] = 0x3,
	[XO4_BBLPM_EN_MSK] = 0x1,
	[XO7_MODE] = 0x3,
	[XO7_EN_M] = 0x1,
	[XO7_ISET_M] = 0x3,
	[XO7_BBLPM_EN_MSK] = 0x1,
	[XO_BB_LPM_EN_M] = 0x1,
...
{
	pmic_clkbuf_update(XO_COFST_FPM, 0, 0);
	pmic_clkbuf_update(XO_CORE_IDAC_FPM, 0, 2);
	pmic_clkbuf_update(XO_AAC_FPM_SWEN, 0, 0);
	mdelay(1);

	pmic_clkbuf_update(XO_AAC_FPM_SWEN, 0, 1);
	mdelay(5);
}

static void mt6357_clk_buf_set_cap_id(u32 capid)
{
	pmic_clkbuf_update(XO_CDAC_FPM, 0, capid);
...
{
	pmic_clkbuf_read(XO_CDAC_FPM, 0, capid);
}
