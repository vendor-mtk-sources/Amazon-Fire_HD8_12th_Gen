 ...
 * Filename:
 * ---------
 *     sc202cs_raspite_raw_lce_rear_Sensor.h
 *
 * Project:
 * --------
 *     ALPS
 ...
 *
 ****************************************************************************/
#ifndef _SC202CS_RASPITE_RAW_LCE_REAR_SENSOR_H
#define _SC202CS_RASPITE_RAW_LCE_REAR_SENSOR_H

/* SENSOR MIRROR FLIP INFO */
#define SC202CS_MIRROR_NORMAL    1
#define SC202CS_MIRROR_H         0
#define SC202CS_MIRROR_V         0
#define SC202CS_MIRROR_HV        0

#if SC202CS_MIRROR_NORMAL
#define SC202CS_MIRROR	        0x00
#elif SC202CS_MIRROR_H
#define SC202CS_MIRROR	        0x06
#elif SC202CS_MIRROR_V
#define SC202CS_MIRROR	        0x60
#elif SC202CS_MIRROR_HV
#define SC202CS_MIRROR	        0x66
#else
#define SC202CS_MIRROR	        0x00
#endif
...
#define SC202CS_SENSOR_GAIN_BASE             0x400
#define SC202CS_SENSOR_GAIN_MAX              (3175 * SC202CS_SENSOR_GAIN_BASE /100)
#define SC202CS_SENSOR_GAIN_MAX_VALID_INDEX  5
//#define SC202CS_SENSOR_DGAIN_BASE          0x400
