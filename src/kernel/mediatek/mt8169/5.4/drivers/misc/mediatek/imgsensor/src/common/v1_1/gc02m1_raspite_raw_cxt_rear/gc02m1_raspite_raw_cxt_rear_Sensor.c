 ...
 * Filename:
 * ---------
 *    gc02m1_raspite_raw_cxt_rear_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "gc02m1_raspite_raw_cxt_rear_Sensor.h"

/************* Modify Following Strings for Debug ****************/
#define PFX "gc02m1_raspite_cxt_rear_camera_sensor"
#define LOG_1 LOG_INF("gc02m1_raspite_cxt_rear_camera_sensor, MIPI 1LANE\n")
/********************** Modify end  ******************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1_RASPITE_CXT_REAR_SENSOR_ID,
...
UINT32 GC02M1_RASPITE_CXT_REAR_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
