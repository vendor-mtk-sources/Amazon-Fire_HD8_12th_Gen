...
static const struct of_device_id of_match_clk_mt8169_imp_iic_wrap[] = {
	{
		.compatible = "mediatek,mt8169-imp_iic_wrap",
...
static struct platform_driver clk_mt8169_imp_iic_wrap_drv = {
	.probe = mtk_clk_simple_probe,
	.driver = {
		.name = "clk-mt8169-imp_iic_wrap",
		.of_match_table = of_match_clk_mt8169_imp_iic_wrap,
	},
};

static int __init clk_mt8169_imp_iic_wrap_init(void)
{
	return platform_driver_register(&clk_mt8169_imp_iic_wrap_drv);
}

static void __exit clk_mt8169_imp_iic_wrap_exit(void)
{
	platform_driver_unregister(&clk_mt8169_imp_iic_wrap_drv);
}

module_init(clk_mt8169_imp_iic_wrap_init);
module_exit(clk_mt8169_imp_iic_wrap_exit);
MODULE_LICENSE("GPL");
