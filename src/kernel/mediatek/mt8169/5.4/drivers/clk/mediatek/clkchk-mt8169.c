...
static const char * const all_clk_names[] = {
	...
	"infra_ao_spi2",
	"infra_ao_spi3",
	"infra_ao_ssusb_ref_ck",
	"infra_ao_ssusb_xhci_ck",
	"infra_ao_ssusb_p1_ref_ck",
	"infra_ao_ssusb_p1_xhci_ck",
	"infra_ao_sspm",
	"infra_ao_ssusb_p1_sys_ck",
	"infra_ao_i2c5",
	"infra_ao_i2c5a",
	"infra_ao_i2c5_imm",
	"infra_ao_i2c1a",
	...
	"infra_ao_aes_top0_bclk_ck",
	"infra_ao_mcu_pm_bclk_ck",
	"infra_ao_ccif2_ap",
	"infra_ao_ccif2_md",
	"infra_ao_ccif3_ap",
	"infra_ao_ccif3_md",
	...
	"infra_ao_ccif4_md",
	"infra_ao_fadsp_ck",
	"infra_ao_flashif_133m_ck",
	"infra_ao_flashif_66m_ck",
	"adsp_core",
	"adsp_coredbg_en",
	"adsp_timer_en",
	"adsp_dma_en",
...
static const char * const compatible[] = {"mediatek,mt8169", NULL};
