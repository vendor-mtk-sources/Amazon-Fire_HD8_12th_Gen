...
bool (*mtk_fh_set_rate_cb)(int pll_id, unsigned long dds, int postdiv) = NULL;
EXPORT_SYMBOL(mtk_fh_set_rate_cb);
		...
		unsigned long parent_rate)
{
	...
	if (!mtk_fh_set_rate_cb || !mtk_fh_set_rate_cb(pll->data->id, pcw, postdiv))
