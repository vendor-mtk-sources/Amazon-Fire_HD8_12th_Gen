...
#include <dt-bindings/interconnect/mtk,mt8169-emi.h>
...
DEFINE_MNODE(nna_0, MASTER_NNA_0, 0, SLAVE_DDR_EMI);
DEFINE_MNODE(nna_1, MASTER_NNA_1, 0, SLAVE_DDR_EMI);
DEFINE_MNODE(adsp,  MASTER_ADSP, 0, SLAVE_DDR_EMI);
...
static struct mtk_icc_node *mt8169_icc_nodes[] = {
	[MT8169_SLAVE_DDR_EMI] = &ddr_emi,
	[MT8169_MASTER_MCUSYS] = &mcusys,
	[MT8169_MASTER_GPUSYS] = &gpu,
	[MT8169_MASTER_MMSYS] = &mmsys,
	[MT8169_MASTER_MM_VPU] = &mm_vpu,
	[MT8169_MASTER_MM_DISP] = &mm_disp,
	[MT8169_MASTER_MM_VDEC] = &mm_vdec,
	[MT8169_MASTER_MM_VENC] = &mm_venc,
	[MT8169_MASTER_MM_CAM] = &mm_cam,
	[MT8169_MASTER_MM_IMG] = &mm_img,
	[MT8169_MASTER_MM_MDP] = &mm_mdp,
	[MT8169_MASTER_VPUSYS] = &vpusys,
	[MT8169_MASTER_VPU_0] = &vpu_port_0,
	[MT8169_MASTER_VPU_1] = &vpu_port_1,
	[MT8169_MASTER_WIFI] = &wifi,
	[MT8169_MASTER_BT] = &bt,
	[MT8169_MASTER_NNA_0] = &nna_0,
	[MT8169_MASTER_NNA_1] = &nna_1,
	[MT8169_MASTER_ADSP] = &adsp,
	[MT8169_MASTER_DBGIF] = &dbgif,

	[MT8169_SLAVE_HRT_DDR_EMI] = &hrt_ddr_emi,
	[MT8169_MASTER_HRT_MMSYS] = &hrt_mmsys,
	[MT8169_MASTER_HRT_MM_DISP] = &hrt_mm_disp,
	[MT8169_MASTER_HRT_MM_VDEC] = &hrt_mm_vdec,
	[MT8169_MASTER_HRT_MM_VENC] = &hrt_mm_venc,
	[MT8169_MASTER_HRT_MM_CAM] = &hrt_mm_cam,
	[MT8169_MASTER_HRT_MM_IMG] = &hrt_mm_img,
	[MT8169_MASTER_HRT_MM_MDP] = &hrt_mm_mdp,
	[MT8169_MASTER_HRT_DBGIF] = &hrt_dbgif,
};

static struct mtk_icc_desc mt8169_icc = {
	.nodes = mt8169_icc_nodes,
	.num_nodes = ARRAY_SIZE(mt8169_icc_nodes),
};
...
static const struct of_device_id emi_icc_of_match[] = {
	...
	{ .compatible = "mediatek,mt8169-dvfsrc", .data = &mt8169_icc },
	{ },
};
