...
static const unsigned int mt8169_voltages[] = {
	650000,
	700000,
	800000,
};

static struct dvfsrc_regulator mt8169_regulators[] = {
	MT_DVFSRC_REGULAR("dvfsrc-vcore", VCORE,
		mt8169_voltages),
	MT_DVFSRC_REGULAR("dvfsrc-vscp", VSCP,
		mt8169_voltages),
...
static const struct dvfsrc_regulator_init_data regulator_mt8169_data = {
	.size = ARRAY_SIZE(mt8169_regulators),
	.regulator_info = &mt8169_regulators[0],
};
