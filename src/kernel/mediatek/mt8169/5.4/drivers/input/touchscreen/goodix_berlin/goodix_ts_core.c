...
static int goodix_ts_pen_dev_config(struct goodix_ts_core *core_data)
{
	...
	input_set_abs_params(pen_dev, ABS_MT_TOUCH_MAJOR, 0,
				ts_bdata->panel_max_p, 0, 0);
