...
#include "pinctrl-mtk-mt8169.h"
#include "pinctrl-paris.h"

/* MT8169 have multiple bases to program pin configuration listed as the below:
 * gpio_base:0x10005000, iocfg_lt_base:0x10002000, iocfg_lm_base:0x10002200,
 * iocfg_lb_base:0x10002400, iocfg_bl:0x10002600_base, iocfg_rb_base:0x10002800,
 * iocfg_rt_base:0x10002C00.
...
static const struct mtk_pin_field_calc mt8169_pin_mode_range[] = {
	PIN_FIELD(0, 184, 0x300, 0x10, 0, 4),
};

static const struct mtk_pin_field_calc mt8169_pin_dir_range[] = {
	PIN_FIELD(0, 184, 0x0, 0x10, 0, 1),
};

static const struct mtk_pin_field_calc mt8169_pin_di_range[] = {
	PIN_FIELD(0, 184, 0x200, 0x10, 0, 1),
};

static const struct mtk_pin_field_calc mt8169_pin_do_range[] = {
	PIN_FIELD(0, 184, 0x100, 0x10, 0, 1),
};

static const struct mtk_pin_field_calc mt8169_pin_ies_range[] = {
...
static const struct mtk_pin_field_calc mt8169_pin_smt_range[] = {
...
static const struct mtk_pin_field_calc mt8169_pin_pu_range[] = {
...
static const struct mtk_pin_field_calc mt8169_pin_pd_range[] = {
...
static const struct mtk_pin_field_calc mt8169_pin_pupd_range[] = {
...
static const struct mtk_pin_field_calc mt8169_pin_r0_range[] = {
...
static const struct mtk_pin_field_calc mt8169_pin_r1_range[] = {
...
static const struct mtk_pin_field_calc mt8169_pin_drv_range[] = {
...
static const struct mtk_pin_field_calc mt8169_pin_drv_adv_range[] = {
...
static const struct mtk_pin_field_calc mt8169_pin_rsel_range[] = {
...
static const unsigned int mt8169_pull_type[] = {
...
static const struct mtk_pin_reg_calc mt8169_reg_cals[PINCTRL_PIN_REG_MAX] = {
	[PINCTRL_PIN_REG_MODE] = MTK_RANGE(mt8169_pin_mode_range),
	[PINCTRL_PIN_REG_DIR] = MTK_RANGE(mt8169_pin_dir_range),
	[PINCTRL_PIN_REG_DI] = MTK_RANGE(mt8169_pin_di_range),
	[PINCTRL_PIN_REG_DO] = MTK_RANGE(mt8169_pin_do_range),
	[PINCTRL_PIN_REG_SR] = MTK_RANGE(mt8169_pin_dir_range),
	[PINCTRL_PIN_REG_SMT] = MTK_RANGE(mt8169_pin_smt_range),
	[PINCTRL_PIN_REG_IES] = MTK_RANGE(mt8169_pin_ies_range),
	[PINCTRL_PIN_REG_PU] = MTK_RANGE(mt8169_pin_pu_range),
	[PINCTRL_PIN_REG_PD] = MTK_RANGE(mt8169_pin_pd_range),
	[PINCTRL_PIN_REG_DRV] = MTK_RANGE(mt8169_pin_drv_range),
	[PINCTRL_PIN_REG_PUPD] = MTK_RANGE(mt8169_pin_pupd_range),
	[PINCTRL_PIN_REG_R0] = MTK_RANGE(mt8169_pin_r0_range),
	[PINCTRL_PIN_REG_R1] = MTK_RANGE(mt8169_pin_r1_range),
	[PINCTRL_PIN_REG_DRV_ADV] = MTK_RANGE(mt8169_pin_drv_adv_range),
	[PINCTRL_PIN_REG_RSEL]	= MTK_RANGE(mt8169_pin_rsel_range),

};

static const char * const mt8169_pinctrl_register_base_names[] = {
	"gpio_base", "iocfg_lt_base", "iocfg_lm_base", "iocfg_lb_base",
	"iocfg_bl_base", "iocfg_rb_base", "iocfg_rt_base",
};

static const struct mtk_eint_hw mt8169_eint_hw = {
	.port_mask = 0xf,
	.ports     = 7,
	.ap_num    = 217,
	.db_cnt    = 32,
...
static const struct mtk_pin_soc mt8169_data = {
	.reg_cal = mt8169_reg_cals,
	.pins = mtk_pins_mt8169,
	.npins = ARRAY_SIZE(mtk_pins_mt8169),
	.ngrps = ARRAY_SIZE(mtk_pins_mt8169),
	.nfuncs = 8,
	.gpio_m = 0,
	.eint_hw = &mt8169_eint_hw,
	.race_free_access = true,
	.base_names = mt8169_pinctrl_register_base_names,
	.nbase_names = ARRAY_SIZE(mt8169_pinctrl_register_base_names),
	.pull_type = mt8169_pull_type,
...
static const struct of_device_id mt8169_pinctrl_of_match[] = {
	{ .compatible = "mediatek,mt8169-pinctrl", },
	{ }
};

static int mt8169_pinctrl_probe(struct platform_device *pdev)
{
	return mtk_paris_pinctrl_probe(pdev, &mt8169_data);
}

static struct platform_driver mt8169_pinctrl_driver = {
	.driver = {
		.name = "mt8169-pinctrl",
		.of_match_table = mt8169_pinctrl_of_match,
		.pm = &mtk_paris_pinctrl_pm_ops,
	},
	.probe = mt8169_pinctrl_probe,
};

module_platform_driver(mt8169_pinctrl_driver);
