...
enum VAL_MEM_TYPE_T {
	...
	VAL_MEM_TYPE_FOR_GCE_PA_PAGE,
	VAL_MEM_TYPE_FOR_SEC,
...
struct vcu_v4l2_callback_func {
	...
	void (*enc_lock)(void *ctx_lock,
		unsigned int core_id, unsigned int *flags);
	void (*enc_unlock)(void *ctx_lock,
...
extern void venc_lock(void *ctx_lock, unsigned int core_id, unsigned int *flags);
extern void venc_unlock(void *ctx_unlock, unsigned int core_id);
