...
void mtk_prepare_vdec_emi_bw(struct mtk_vcodec_dev *dev)
{
	...
	i = 0;
	dev->vdec_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l4_mc");
	dev->vdec_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l4_ufo");
	dev->vdec_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l4_pp");
	dev->vdec_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l4_pred_rd");
	dev->vdec_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l4_pred_wr");
	dev->vdec_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l4_ppwrap");
	dev->vdec_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l4_tile");
	dev->vdec_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l4_vld");
	dev->vdec_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l4_vld2");
	dev->vdec_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l4_avc_mv");
	dev->vdec_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l4_ufo_enc");
	dev->vdec_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l4_rdma");
...
void mtk_vdec_emi_bw_begin(struct mtk_vcodec_ctx *ctx, int hw_id)
{
	...
	*/
	...
	mtk_icc_set_bw(pdev->vdec_qos_req[0],
						MBps_to_icc(emi_bw), 0);
	mtk_icc_set_bw(pdev->vdec_qos_req[1], MBps_to_icc(1), 0);
	mtk_icc_set_bw(pdev->vdec_qos_req[3], MBps_to_icc(1), 0);
	mtk_icc_set_bw(pdev->vdec_qos_req[4], MBps_to_icc(1), 0);
	mtk_icc_set_bw(pdev->vdec_qos_req[5], MBps_to_icc(1), 0);
	mtk_icc_set_bw(pdev->vdec_qos_req[6], MBps_to_icc(1), 0);
	...
	mtk_icc_set_bw(pdev->vdec_qos_req[11], MBps_to_icc(20), 0);
#endif
}
